...
label_z_file = 'D:/data_signal_MTI/project_util_3/prediction_result/label_z_2dfft_fold.npy'
...
sp0 = gl.GLScatterPlotItem(pos=expect_xyz[0:2040], color=colors_2, pxMode=True, size=20)
w.addItem(sp0)
