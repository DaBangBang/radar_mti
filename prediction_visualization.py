...
sp0 = gl.GLScatterPlotItem(pos=expect_xyz[9200:9400], color=colors_2, pxMode=True, size=20)
w.addItem(sp0)
sp1 = gl.GLScatterPlotItem(pos=expect_p[9200:9400], color = colors_1, pxMode=True, size=20)
w.addItem(sp1)
