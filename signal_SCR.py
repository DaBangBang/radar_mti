...
def cal_scr(range_tresh, range_tresh_mov, range_tresh_stove
    ...
    plt.plot(range_fft_bg_sub[10,0,:,0], color='black')
    plt.plot(range_fft_mov[10,0,:,0], color='orange')
    # plt.plot(np.full(100, Cin[0,0,0]), color='black')
    # plt.plot(np.full(100, Cout[5,0,0]), color='red')
    ...
    plt.figure(3)
    plt.plot(snr_bg_sub[0:20,0,0])
    plt.plot(snr_mov[0:20,0,0])
    plt.plot(snr_stove[0:20,0,0])
    plt.plot(snr_fir[0:20,0,0])
    plt.plot(snr_iir[0:20,0,0])
