...
model_path = 'D:/signal_MTI/training_model/wandb/run-20200709_035516-1h44rqo4/aoa_fir_6cov_1.pt'
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.fc_origin = nn.Linear(in_features=19200, out_features=200)
        
        self.fc1_1 = nn.Linear(in_features=200, out_features=100)
        self.fc1_2 = nn.Linear(in_features=200, out_features=100)
        # self.fc2 = nn.Linear(in_features=200, out_features=100)
        self.fc2_1 = nn.Linear(in_features=150, out_features=50)
        self.fc2_2 = nn.Linear(in_features=150, out_features=50)


    def forward(self, x):

        
        x = F.leaky_relu(self.fc_origin(x))
...
class Radar_train_Dataset(Dataset):
    def __init__(self, real_part, label_file):
        ...
        data_fft_modulus = np.reshape(data_fft_modulus, (data_fft_modulus.shape[0], -1))
...
if __name__ == '__main__':
    ...
    if args.test_only:
        ...
        np.save(save_predict_path + 'expect_z_2', expect_z)
        np.save(save_predict_path + 'expect_phi_2', expect_phi)
