...
signal_dir = 'D:/data_signal_MTI/project_util/signal_all_wo_mti_pack/'
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=16*16, out_features=128)
...
if __name__ == '__main__':
    ...
    for f_name in range(all_trajectory):
        count += 1
        real_name = signal_dir + 'raw_iq_wo_mti_' + str(count) + '.npy' 
