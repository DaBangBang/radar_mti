...
model_path = 'D:/signal_MTI/training_model/wandb/run-20200708_193704-3dvcteat/aoa_fir_6cov_1.pt'
...
if __name__ == '__main__':
    ...
    if args.test_only:
        ...
        np.save(save_predict_path + 'expect_z_1', expect_z)
        np.save(save_predict_path + 'expect_phi_1', expect_phi)
