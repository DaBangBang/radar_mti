...
learning_rate = 0.001
mm = 1e-3
bin_resolution = 46.8410 / 6 ## millimeter = 4.6 cm
padding = 1000
train_all = []
test_all = []
train_label_all = []
...
def data_preparation(data_real, data_imag, label):
    ...
    data_fft_modulus = data_fft_modulus[:,:,:int(data_fft_modulus.shape[2]/12)]
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), os.path.join(wandb.run.dir, 'AE_4.pt'))
