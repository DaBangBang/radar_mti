...
class Model(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=13*16, out_features=200)
...
if __name__ == '__main__':
    ...
    for f_name in folder_name:
        count += 1
        real_name = f_name + '/range_fft_zero_pad_500_fir*'
    ...
    torch.save(model.state_dict(), os.path.join(wandb.run.dir, 'fir_conv6_3.pt'))
