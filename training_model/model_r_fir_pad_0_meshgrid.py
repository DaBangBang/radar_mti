...
def L2_loss(output, label):
    ...
    # print('output =', output[0], 'mr =', m_r, 'expect = ', expect[0])
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(in_features=16*1, out_features=16)
    ...
    def forward(self, x):
        ...
        # x_2 = F.leaky_relu(self.encode_conv5(x))
        # x_2 = x_2.view(x_2.size(0), -1)
        # x_2 = F.leaky_relu(self.fc1(x_2))
        # x_2 = self.fc2(x_2)
        # print(x)
        # print(x)
        # return x_1, x_2
