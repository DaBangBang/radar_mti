...
class Model(nn.Module):
    def __init__(self):
        ...
        # 2D-CNN Layer
        self.encode_conv1 = nn.Conv1d(in_channels=16, out_channels=8, kernel_size=3, stride = 1, padding=1)
...
if __name__ == '__main__':
    ...
    if args.save_to_wandb:
        run = wandb.init(project="localization_net_experiment", name="test_aoa_zone_9"+str(fold), dir='/home/nakorn/weight_bias', reinit=True)
