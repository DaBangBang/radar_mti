...
def main():
    ...
    folder_name = glob.glob('D:/data_signal_MTI/project_util_3/signal_robot_3_raw')
    ...
    for sub_f in folder_name:
        ...
        for ss in sub_bin:
            ...
            # runGraphInitial()
            save_real = 'D:/data_signal_MTI/project_util_3/signal_robot_3_preprocess/raw_signal_real_' + str(name_count)
            save_imag = 'D:/data_signal_MTI/project_util_3/signal_robot_3_preprocess/raw_signal_imag_' + str(name_count)
