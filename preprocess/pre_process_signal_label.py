...
#for robot
dir_project = 'D:/data_signal_MTI/project_util_3/'
sig_dir = 'D:/data_signal_MTI/project_util_3/signal_robot_3_all_wo_mti'
label_dir = 'D:/data_signal_MTI/project_util_3/label_all_robot_3'
signal_folder = [dir_project + 'signal_robot_3_preprocess/']
label_folder = [dir_project + 'label_robot_3/']
